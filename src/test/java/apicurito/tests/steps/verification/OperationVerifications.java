...
public class OperationVerifications {
    ...
    public void checkThatOperationConsumes(String consumes) {
        ...
        CollectorHelper.getCollector().assertThat(consumesSubsection.getText()).as("Overriden consumes should be %s but is %s", consumes, consumesSubsection.getText()).isEqualTo(consumes);
    }
    ...
    public void checkThatOperationProduces(String produces) {
        ...
        CollectorHelper.getCollector().assertThat(producesSubsection.getText()).as("Overriden consumes should be %s but is %s", produces, producesSubsection.getText()).isEqualTo(produces);
    }
