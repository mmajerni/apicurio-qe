...
Feature: Data types tests
  ...
  @createDataTypeWithExample
  Scenario: create data type with example
    ## Test checks that properties will be created for given json example
    When create a new API
    And create a new data type by link
    ...
    Then check that example is {"name" : "John", "age" : 24, "isMan" : true}
